import "./styles/SparkleResumeButton.css";

const SparkleResumeButton = () => {
  return (
    <a
      className="sparkle-resume-wrapper"
      href="/CV/CV - RHETT WAYNE MANUBAG.pdf"
      target="_blank"
      rel="noreferrer"
    >
      <div className="sp">
        <button className="sparkle-button" type="button" tabIndex={-1}>
...
export default SparkleResumeButton;
